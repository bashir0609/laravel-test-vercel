...
@section('title', 'Get Clean, Verified B2B Leads That Convert - Islah Web Service')
...
<nav class="fixed top-0 left-0 right-0 bg-white/95 backdrop-blur-sm shadow-sm z-50">
    <div class="container mx-auto px-4 sm:px-6 lg:px-8">
        <div class="flex justify-between items-center h-16">
            <a href="#home" class="flex items-center space-x-3" aria-label="Islah Web Service home">
...
<!-- Hero Section -->
<section class="pt-20 lg:pt-28 py-20 lg:py-28 bg-gradient-to-b from-transparent via-white to-white dark:via-zinc-900 dark:to-zinc-900" id="home">
    <div class="container mx-auto px-4 sm:px-6 lg:px-8">
