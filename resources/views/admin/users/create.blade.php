...
@section('content')
<div class="mb-6">
    <a href="{{ route('admin.users.index') }}" class="text-blue-600 hover:text-blue-800 text-sm">← Back to Users</a>
    <h2 class="text-3xl font-bold text-gray-800 mt-2">Create New User</h2>
</div>
